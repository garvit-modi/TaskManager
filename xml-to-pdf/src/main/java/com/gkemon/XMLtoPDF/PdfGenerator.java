...
public class PdfGenerator {
    ...
    public static ContextStep getBuilder(String packageName) {
        LIBRARY_PACKAGE_NAME = packageName;
        return new Builder();
    }
    ...
    public void setLibraryPackageName(String LIBRARY_PACKAGE_NAME) {
        this.LIBRARY_PACKAGE_NAME = LIBRARY_PACKAGE_NAME;
    }
    ...
    public static class Builder implements Build, FileNameStep, PageSizeStep
        ...
        private Integer mPdfPageAvailableHeight = 0;
        private ViewGroup mPdfPageView = null;
        ...
        private void openGeneratedPDF() {
            ...
            if (file.exists()) {
                Uri path = FileProvider.getUriForFile(context, LIBRARY_PACKAGE_NAME + ".provider", file);
...
//                        if (pageHeightInPixel <= a4HeightInPostScript) {
...
//                        } else {
//                            int x = pageHeightInPixel;
//                            int y = 1;
//                            do {
//
//                                PdfDocument.PageInfo pageInfo = new PdfDocument.PageInfo.Builder((pageWidthInPixel), (a4HeightInPostScript), i + y++).create();
//                                PdfDocument.Page page = document.startPage(pageInfo);
//                                content.layout(0, 0, pageWidthInPixel, pageHeightInPixel);
//                                content.draw(page.getCanvas());
////                                Paint p = new Paint();
...
////                                c.drawText("afasdf", 100, 100, p);
////                                c.drawText("afasdf", 200, 500, p);
////                                c.drawText("afasdf", 300, 1000, p);
////                                c.drawText("afasdf", 400, 1500, p);
////                                c.drawText("afasdf", 500, 2000, p);
////                                c.drawText("afasdf", 600, 2500, p);
////                                c.drawText("afasdf", 700, 3000, p);
////                                c.drawText("afasdf", 800, 3500, p);
////                                c.drawText("afasdf", 900, 4000, p);
////                                c.drawText("afasdf", 1000, 4500, p);
//                                document.finishPage(page);
//                                x -= a4HeightInPostScript;
//                            }
//                            while (x > 0);
